...
const LandscapeBoxs = ({ title }) => {
  return (
    <div className="relative w-full flex flex-col gap-5 md:gap-6 py-5 md:py-10">
        ...
        <div className="w-full h-40 px-5 md:px-10 grid grid-cols-[repeat(4,minmax(95px,309px))] grid-rows-1 md:grid-cols-[repeat(4,minmax(95px,302px))] gap-x-56 md:gap-x-6 overflow-x-auto">
